export const homeInfos = {
  ...
  projectSectionCards: [
    {
      ...
      description: "O TurisMendes é um projeto que conectará Mendes-RJ ao seu patrimônio cultural, histórico, artístico e educacional. Desenvolvido para a Secretaria de Turismo, é viabilizado pela parceria entre o Coletivo Cafeína e a SomosDev Tech. O projeto inclui uma plataforma online interativa, placas turísticas com QR Codes – que permitirão acesso a fotos em 360º, mapas interativos e informações sobre pontos culturais da cidade – e uma plataforma de gerenciamento, onde os administradores poderão registrar, editar e excluir dados do sistema. Mais que uma iniciativa pontual, o TurisMendes nasce para deixar um legado duradouro, fortalecendo o turismo e a cultura regional e consolidando Mendes como um destino vibrante. O lançamento está previsto para maio de 2025",
      photoSide: "LEFT",
      cardImage: "https://storage.googleapis.com/api-flamengo/coletivo-cafeina/imagens-coletivo/turismendes-logo-ideia4.png",
      linkUrl: "https://github.com/SomosDevTech/tourist-mendes_StaticWebSite"
    },
    {
      id: 2,
      title: "A Caninha Verde de Vassouras",
      description: "'A Caninha Verde de Vassouras' é um mini documentário produzido pelo Coletivo Cafeína, que resgata a história e tradição da caninha verde na cidade. Com depoimentos de moradores antigos, como Seu Manoel, o filme valoriza a cultura local e sua identidade. Realizado com recursos do Edital Paulo Gustavo, o documentário celebra a memória e o saber popular, mantendo viva essa tradição.",
      photoSide: "RIGHT",
    ...
    },
    {
      ...
      description: "'Hoje é Dia de Rock' é um documentário que retrata a relação de Mendes com o rock nacional, desde os anos 1960 até o surgimento do Festival Hoje é Dia de Rock, o maior evento de bandas autorais do Vale do Café fluminense. A cidade recebeu nomes como Bi Ribeiro (Paralamas), Jander Bilaphra (Plebe Rude) e Renato Rocha (Legião Urbana), que foram morar na cidade, ajudando a fortalecer a cena local e inspiraram o surgimento de bandas autorais, como a banda Atrito. O documentário também destaca o festival, que abriu espaço para bandas importantes da cena underground brasileira, como Menores Atos e Ventre (Lollapalooza) e Medulla e Rancore (MTV), consolidando Mendes como um polo do rock independente.",
      photoSide: "LEFT",
    ...
    },
    {
      ...
      description: "O Cafeína Sessions é um espaço para músicos autorais registrarem suas performances em Live Sessions gravadas em estúdio profissional. As apresentações tem captação de áudio e vídeo de alta qualidade, passando por mixagem e masterização, e sendoo divulgadas em plataformas digitais e eventos locais. O projeto busca dar visibilidade aos artistas da região, fortalecer a cena musical local e criar um acervo que valorize a diversidade artística.",
      photoSide: "RIGHT",
    ...
    },
    {
      ...
      description: "O Hoje é Dia de Rock é um festival independente que marcou a cena cultural de Mendes-RJ e Vassouras-RJ ao longo de cinco edições, reunindo grandes nomes do rock alternativo nacional. Desde 2010, o evento já recebeu bandas como Medulla, El Efecto, Teco Martins (Rancore), Menores Atos, Ventre, Canto Cego e muitas outras, algumas das quais seguiram para grandes palcos como Lollapalooza e Rock in Rio. Além da música, o festival sempre integrou arte em diversas formas, com exposições, teatro, oficinas e intervenções. Em 2024, voltou à ativa com nomes como Plastic Fire, Estorvo, O Nilton e Traste. Agora, o Hoje é Dia de Rock se prepara para mais uma edição em maio de 2025, reafirmando seu papel como um espaço essencial para a cena independente.",
      photoSide: "LEFT",
  ...
  gallery: [],
  footer: {
    coletivoLogoUrl: "https://storage.googleapis.com/api-flamengo/coletivo-cafeina/imagens-coletivo/coletivo-cafeina.png"
  }
}